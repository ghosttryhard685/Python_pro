...
async def on_ready():
    ...
    if channel:
        await channel.send('''Hola, soy Mr.Calculator y soy una calculadora.
                    ...
                    1- sum: Con este comando podras sumar dos numeros
                    2- substract: Con este comando podras restar dos numeros
                    3- multiply: Con este comando podras multiplicar dos numeros
                    4- divide: Con este comando podras dividir dos numeros
...
async def raiz(ctx, left: int):
    ...
    await ctx.send(raiz)
@bot.command()
async def power(ctx, base: int, exponent: int):
